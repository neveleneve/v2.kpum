                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <form method="post">
                                    ...
                                    <input type="text" class="form-control mb-3" id="pencarian" name="pencarian"
                                        value="{{ session('pencarian') ? session('pencarian') : null }}" required>
                        ...
                        @if (session('datamhs'))
                            ...
                            @if (count(session('datamhs')) > 0)
                                @if (session('datamhs')[0]['level'] == 0 || session('datamhs')[0]['level'] == 1)
                                    <div class="row justify-content-center">
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <h3 class="font-weight-bold text-center">Data Tidak Ditemukan</h3>
                                        </div>
                                    </div>
                                @else
                                    <div class="row justify-content-center">
