                        ...
                        <form action="{{ route('updatecalon') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input class="form-control mb-3" type="text" required name="no_urut" id="no_urut"
                                        onkeypress="return isNumberKey(event)" value="{{ $data[0]['no_urut'] }}" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input class="form-control mb-3" type="text" name="ketua" id="ketua" required
                                        onkeypress="return isCharKey(event)" value="{{ $data[0]['ketua'] }}">
                                    ...
                                    <input class="form-control mb-3" type="text" name="nimketua" id="nimketua" required
                                        onkeypress="return isNumberKey(event)" value="{{ $data[0]['nimketua'] }}">
                                    ...
                                    <select class="form-control mb-3" name="jurusanketua" id="jurusanketua" required>
                                        <option value="Teknik Informatika"
                                            {{ $data[0]['jurusanketua'] == 'Teknik Informatika' ? 'selected' : null }}>
                                            Teknik Informatika (IF)
                                        </option>
                                        <option value="Sistem Informasi"
                                            {{ $data[0]['jurusanketua'] == 'Sistem Informasi' ? 'selected' : null }}>
                                            Sistem Informasi (SI)
                                        </option>
                                        <option value="Komputer Akuntansi"
                                            {{ $data[0]['jurusanketua'] == 'Komputer Akuntansi' ? 'selected' : null }}>
                                ...
                                <div class="col-6">
                                    ...
                                    <input class="form-control mb-3" type="text" name="nimwakil" id="nimwakil" required
                                        onkeypress="return isNumberKey(event)" value="{{ $data[0]['nimwakil'] }}">
                                    ...
                                    <select class="form-control mb-3" name="jurusanwakil" id="jurusanwakil" required>
                                        <option value="Teknik Informatika"
                                            {{ $data[0]['jurusanwakil'] == 'Teknik Informatika' ? 'selected' : null }}>
                                            Teknik Informatika (IF)
                                        </option>
                                        <option value="Sistem Informasi"
                                            {{ $data[0]['jurusanwakil'] == 'Sistem Informasi' ? 'selected' : null }}>
                                            Sistem Informasi (SI)
                                        </option>
                                        <option value="Komputer Akuntansi"
                                            {{ $data[0]['jurusanwakil'] == 'Komputer Akuntansi' ? 'selected' : null }}>
                                            Komputer Akuntansi (KA)
                                        </option>
                                    </select>
                                    ...
                                    <input class="form-control mb-3" type="text" name="angkatanwakil" id="angkatanwakil"
                                        required onkeypress="return isNumberKey(event)"
                                        value="{{ $data[0]['angkatanwakil'] }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <label for="visi">Visi Pasangan Calon</label>
                                    <textarea class="form-control mb-3" name="visi" id="visi" rows="5"
                                        required>{{ $data[0]['visi'] }}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <label for="misi">Misi Pasangan Calon</label>
                                    <textarea class="form-control mb-3" name="misi" id="misi" rows="10"
                                        required>{{ $data[0]['misi'] }}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12 text-center">
                                    <img class="w-50 img-responsive img-thumbnail mb-3"
                                        src="{{ asset('images/paslon/' . $data[0]['no_urut'] . '.jpg') }}" alt="">
                                </div>
                                <div class="col-12">
